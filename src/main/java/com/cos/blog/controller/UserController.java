...
public class UserController {
	...
	public String kakaoCallback(String code) { // Data를 리턴해주는 컨트롤러 함수
		...
		// apiKey 변수 설정
		String apiKey = "본인_카카오_API_Token";
		
		// POST 방식으로 key=value 데이터를 요청(카카오쪽으로)
		// 라이브러리 종류 - HttpsURLConnection, Retrofit2(안드로이드에서 많이 사용), OkHttp, ResTemplate 등
		...
		// Gson, Json Simple, ObjectMapper 등의 라이브러리 중 선택
